...
<head>
  ...
  <title>Cadastrar Livro • Book Store Brasil</title>
          ...
          <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
              ...
              <div class="container-fluid">
                ...
                <!-- Page Heading -->
                <h1 class="h3 mb-4 text-gray-800">Cadastrar Livro</h1>
                ...
                <div class="card shadow mb-4">
                  ...
                  <div class="card-body">
                    ...
                    <form action="addLivro.php" method="POST" enctype="multipart/form-data" id="cadastro">

                      <div class="row">
                        <div class="col-md-6">
                          <label>Título do Livro*</label>
                          <input id="titulo" placeholder="Informe o Título do Livro..." name="titulo" class="form-control" required/>
                        </div>
                        <div class="col-md-6">
                          <label>Autor(es)*</label>
                          <input id="autor" name="autor" placeholder="Informe o(s) Autor(es) do Livro..." class="form-control" required/>
                        </div>
                      </div>
                      <div class="row">
                        <div class="col-md-3">
                          <label>Preço*</label>
                          <input id="preco" name="preco" step="0.01" placeholder="Informe o preço..." type="number" maxlength="15" class="form-control"/>
                        </div>
                        <div class="col-md-3">
                          <label>Qtde. em Estoque</label>
                          <input id="estoque" name="estoque" type="number" placeholder="Informe a quantidade em estoque..." maxlength="5" class="form-control"/>
                        </div>
                        <div class="col-md-6">
